...
class Certification(models.Model):
    ...
    class TechnicalDevices(models.TextChoices):
        BQ_1 = '''1.1.  Котлы (паровые, в том числе котлы-бойлеры, а также автономные 
        ...
        BQ_2 = '''1.2. Металлические конструкции для котельного оборудования''', '1.2'
    ...
    technical_devices = models.TextField(
